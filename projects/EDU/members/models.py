...
class Teacher(models.Model):
    teacherKey = models.CharField(max_length=50, primary_key=True, verbose_name='강사키')
...
class Admin(models.Model):
    adminKey = models.CharField(max_length=50, primary_key=True, verbose_name='관리자키')
    type = models.CharField(max_length=10, verbose_name='관리자유형')
    id = models.CharField(max_length=50, verbose_name='관리자id')
    createDate = models.DateTimeField(auto_now_add=True, verbose_name='생성일')
    editDate = models.DateTimeField(auto_now=True, verbose_name='수정일')
