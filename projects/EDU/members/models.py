...
class Teacher(models.Model):
    ...
    profileImg = models.ImageField(blank=True, null=True, upload_to="profile", verbose_name='프로필사진링크')
...
class Student(models.Model):
    ...
    school = models.CharField(null=True, blank=True, max_length=10, verbose_name='학교명')
    grade = models.CharField(null=True, blank=True, max_length=10, verbose_name='학년')
